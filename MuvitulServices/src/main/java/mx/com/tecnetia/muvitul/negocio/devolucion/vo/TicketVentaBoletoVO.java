...
public class TicketVentaBoletoVO {
	...
	private boolean exhibicionVencida;
	
	
	public boolean isExhibicionVencida() {
		return exhibicionVencida;
	}
	public void setExhibicionVencida(boolean exhibicionVencida) {
		this.exhibicionVencida = exhibicionVencida;
	}
