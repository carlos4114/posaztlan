				<div class="x_panel">
					<div class="x_title">
						<h2><i class="fa fa-shopping-cart"></i> Salidas Inventario</h2>
					...
					<div class="x_content">
                      ...
                      <div class="x_panel">
		                <form ng-submit="submit()" name="formSalidasInventario" id="formSalidasInventario" data-parsley-validate class="form-horizontal form-label-left">
				             ...
				             <div class="x_panel">		              	  
		              		...
		              		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
				              		<div class="x_panel">
			              				<br />
					              		<div class="form-group">
					              			 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tipoSalida">Tipo de Salida<span class="required">*</span> 
			                       			 </label>
			                        		<div class="col-md-6 col-sm-6 col-xs-12">
												<select class="form-control col-md-7 col-xs-12" id="tipoSalida" name="tipoSalida" directiva-select2
												ng-options="tipoSalida.idTipoMovimientoInv as tipoSalida.nombre for tipoSalida in listaTiposMovInv"
												ng-model="salidaVO.idTipoMovimiento"
												ng-change="cambiarTipo()">
												<option value="" selected="selected">Selecciona un tipo de salida
												</option>
												</select>
											</div>
					              		</div>			              		
