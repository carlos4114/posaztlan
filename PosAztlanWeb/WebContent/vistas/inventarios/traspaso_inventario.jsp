				<div class="x_panel">
					<div class="x_title">
						<h2><i class="fa fa-shopping-cart"></i> Traspaso Entre Almacenes</h2>
					...
					<div class="x_content">
                      ...
                      <div class="x_panel">
		                <form ng-submit="submit()" name="formTraspaso" id="formTraspaso" data-parsley-validate class="form-horizontal form-label-left">
			              ...
			              <div ng-if="isAdminGral == 'true' || isAdminGralEmpresa == 'true' || isAdminCanal == 'true'">	
				             ...
				             <div class="x_panel">		              	  
			              	  <div ng-if="isAdminGral == 'true'">	
				                 ...
				                 <div ng-if="isAdminGral == 'true' || isAdminGralEmpresa == 'true' || isAdminCanal == 'true'">	   
			                      <div class="form-group">
			                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="perfil">Almacén Origen<span class="required">*</span>
			                        </label>
			                        <div class="col-md-6 col-sm-6 col-xs-12">
			                     ...
			                     <div class="form-group">
			                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="almacenDestino">Almacén Destino<span class="required">*</span>
			                        </label>
			                        <div class="col-md-6 col-sm-6 col-xs-12">
										<select class="form-control col-md-7 col-xs-12" id="almacenDestino" name="almacenDestino" directiva-select2
											ng-options="almacen.id as almacen.nombre for almacen in listaAlmacenesDestino"
											ng-model="salidaVO.idAlmacenConsigna">
											<option value="" selected="selected">Selecciona un almacén
											</option>
										</select>
									</div>
		                   		...
		                   		<table id ="datatable-checkbox" class="table table-striped table-bordered dt-responsive nowrap" role ="grid" aria-describedby="datatable-checkbox_info">
		                   			...
		                   			<tbody>
										<tr ng-repeat="producto in listaProductos">
											<td>
												<div>
													<input type="checkbox" ng-disabled="producto.existencia<=0" class="icheckbox_flat-green" ng-model="producto.seleccionado">
												</div>
											</td>
											...
											<td>
												<div>
													<input type="text" ng-disabled="producto.existencia<=0" ng-model="producto.cantidad" class="col-xs-10">
												</div>
											</td>											
										</tr>
		                    ...
		                    <div class="row">
								<div class="table-responsive col-lg-12 col-md-12 col-sm-12 col-xs-12 col-lg-offset-0 col-md-offset-0 col-sm-offset-0">
									<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
										...
										<tbody>
									    	<tr dir-paginate="p in salidaVO.productos |  filter: filterSearch |itemsPerPage: 10">   
