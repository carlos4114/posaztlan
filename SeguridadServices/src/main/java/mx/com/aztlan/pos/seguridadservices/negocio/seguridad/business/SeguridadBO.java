...
import mx.com.aztlan.pos.infraservices.persistencia.posaztlanbd.dto.Menu;
...
import mx.com.aztlan.pos.seguridadservices.persistencia.posaztlanbd.dao.MenuIbatisDAOI;
...
public class SeguridadBO extends GlobalService{
	...
	public void enviarMailContrasenia(UsuarioLoginVO usuarioVO) throws Exception{
		final String asuntoCorreo = "POS AZTLAN - Accesos";
		
		Map<String,String> velAttrs = new HashMap<String,String>();
   	  	velAttrs.put("contraseniaUsuario", usuarioVO.getContrasenia());

   	  	this.correoElectronicoBO.setTemplate("mx/com/aztlan/pos/seguridadservices/negocio/seguridad/business/RecuperarContraseniaMail.vm");
