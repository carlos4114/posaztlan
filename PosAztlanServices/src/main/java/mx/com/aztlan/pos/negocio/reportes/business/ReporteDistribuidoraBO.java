...
import mx.com.aztlan.pos.infraservices.persistencia.posaztlanbd.dao.ReportesCineXDistribuidoraDAO;
import mx.com.aztlan.pos.infraservices.persistencia.posaztlanbd.dto.ReportesCineXDistribuidora;
import mx.com.aztlan.pos.negocio.reportes.assembler.ReportesCineXDistribuidoraAssembler;
...
public class ReporteDistribuidoraBO {
	...
	public void generarParametros(ReportesCineXDistribuidoraVO reporte){
		...
		if(!reporte.getReportesDistribuidora().getRutaReporteJasper().contains("comscore")){
			asunto = asunto + " - " + reporte.getPelicula()==null?"":reporte.getPelicula().getTitulo();
		}
