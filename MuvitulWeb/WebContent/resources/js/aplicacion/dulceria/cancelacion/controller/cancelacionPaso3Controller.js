...
var cancelacionDulceriaControllerPaso3 = angular.module('indexModule').controller('cancelacionDulceriaControllerPaso3', function($controller,$scope,statusFactory,cancelacionDulceriaService,PropertiesFactory){
	...
	$scope.crearCancelacion = function(cancelacion) {
		...
		cancelacionDulceriaService.crearCancelacion(cancelacion).success(function(data) {
	...
	$scope.resetDatos = function (){
		...
		$scope.ticket 					= null;
		$scope.idTicket 				= null;
		$scope.formCancelacions.$setPristine();
