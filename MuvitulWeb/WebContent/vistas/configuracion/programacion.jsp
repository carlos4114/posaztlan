	...
	<div class="x_panel">
		...
		<div class="x_content">
								...
								<div class="form-group"
									...
									<div class="input-group">
										<span class="input-group-addon"><i
											...
											id="pelicula" directiva-select2 select-width="300px"
									...
									<div class="input-group">
										<div class="input-group bootstrap-timepicker timepicker">
											<span class="input-group-addon"><i
												...
												id="horario" type="text" ng-model="programacion.horario"
												requiered name="horario" class="form-control input-small">
										</div>
									</div>
			...
			<div class="x_panel">
				<div class="row">
					<div
						class="table-responsive col-lg-10 col-md-10 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1">
									...
									<td>
										<ul ng-repeat='programacion in pelicula.programacionesVO'>
											<button type="button" class="btn btn-default btn-xs">
												...
												{{programacion.horario}} <a href=""
													ng-click="eliminarProgramacion(programacion.idProgramacion)"><i
