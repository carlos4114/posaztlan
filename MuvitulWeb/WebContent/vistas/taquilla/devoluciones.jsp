		 <!-- page content -->
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
					<h2><i class="fa fa-asterisk"></i> Devoluciones de Cliente </h2>
                  ...
                  <div class="x_content">
                    ...
                    <form ng-submit="cambiarContrasenia()" name="myForm" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="numeroTicket">N&uacute;mero de Ticket <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" ng-model="numeroTicket" id="constraseniaActual" required="required" class="form-control col-md-7 col-xs-12" placeholder="Contrase&ntilde;a Actual" ng-minlength="3">
