						...
						<div class="accordion" id="accordion" role="tablist"
							...
							<div class="panel">
								<a class="panel-heading collapsed" role="tab" id="headingTwo"
									...
									<h4 class="panel-title">Refresco</h4>
								</a>
							...
							<div class="panel">
								<a class="panel-heading collapsed" role="tab" id="headingThree"
									...
									<h4 class="panel-title">Paquete # 1</h4>
								</a>
								<div id="collapseThree" class="panel-collapse collapse"
									...
									<div class="panel-body">
										...
										<p>
											<strong> <input type="checkbox" class="flat">
												Palomitas
											</strong>
										</p>
										<p>
...
<!-- 						start accordion -->
						<div class="accordion" id="accordion" role="tablist"
							...
							<div class="panel">
								<a class="panel-heading collapsed" role="tab" id="headingTwo"
									data-toggle="collapse" data-parent="#accordion"
									data-target="#panel1" aria-expanded="false"
...
<!-- 					<div class=""> -->
<!-- 						<label> <input type="checkbox" class="js-switch" checked /> -->
<!-- 							Checked -->
<!-- 						</label> -->
<!-- 					</div> -->
<!-- 					<div class=""> -->
