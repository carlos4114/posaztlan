	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div id="wizard" class="form_wizard wizard_horizontal">
				<ul class="wizard_steps">
					<li><a href="" ng-class="status.paso1"
						ng-click=""> <span class="step_no">1</span> <span
							class="step_descr"> Búsqueda Ticket<br />
						</span>
					</a></li>
					<li><a href=""
				...
				<div class="col-md-12 col-sm-12 col-xs-12"
					ng-show="status.numeroPaso ===1" buscar-ticket-devolucion-dulceria></div>
				<div class="col-md-12 col-sm-12 col-xs-12"
					ng-show="status.numeroPaso ===2" generar-devolucion-dulceria></div>
				<div class="col-md-12 col-sm-12 col-xs-12"
					ng-show="status.numeroPaso ===3" terminar-devolucion-dulceria></div>
