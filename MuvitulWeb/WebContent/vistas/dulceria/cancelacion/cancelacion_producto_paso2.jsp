						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="x_panel">
								...
								<div class="row  col-lg-12 col-md-12 col-sm-12 col-xs-12">
									...
									<form id="formCancelacions" name="formCancelacions" novalidate
										class="form-horizontal form-label-left">
										...
										<div class="row  col-lg-5 col-md-5 col-sm-6 col-xs-12">
											<div class="form-group col-md-12 col-sm-12 col-xs-12"
												...
												<div
													ng-show="formCancelacions.motivoCancelacion.$invalid && formCancelacions.motivoCancelacion.$dirty"
													ng-style="{color:'red'}">El campo es requerido.</div>
											</div>

											<div class="form-group  col-md-12 col-sm-12 col-xs-12"
												ng-class="{'has-error': formCancelacions.descripcionCancelacion.$invalid && formCancelacions.descripcionCancelacion.$dirty}">
												...
												<div
													ng-show="formCancelacions.descripcionCancelacion.$invalid && formCancelacions.descripcionCancelacion.$dirty"
													ng-style="{color:'red'}">El campo es requerido.</div>
											</div>
										</div>
